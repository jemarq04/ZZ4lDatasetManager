...
def getDefaultParser():
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Name of file to be created (type pdf/png etc.) Note: Leave unspecified for auto naming",
    )
    parser.add_argument("--hist_file", type=str, default="", help="Read histograms from file")
    parser.add_argument("--legend_left", action="store_true", help="Put legend left or right")
    parser.add_argument(
    ...
    parser.add_argument("--ratio_range", nargs=2, default=[0.4, 1.6], help="Ratio min ratio max (default 0.5 1.5)")
    ...
    parser.add_argument(
        ...
        type=float,
        default=1,
        help="Luminsoity in fb-1. Default 1 fb-1. Set to -1 for unit normalization",
    )
    parser.add_argument("--nostack", action="store_true", help="Don't stack hists")
    parser.add_argument("--no_ratio", action="store_true", help="Do not add ratio comparison")
    parser.add_argument("--no_html", action="store_true", help="Don't copy plot pdfs to website")
    parser.add_argument("--no_data", action="store_true", help="Plot only Monte Carlo")
    parser.add_argument("--no_decorations", action="store_true", help="Don't add CMS plot decorations")
    parser.add_argument("--logy", action="store_true", help="Use logaritmic scale on Y-axis")
    parser.add_argument(
        "-c",
        "--channels",
        type=str,
    ...
    parser.add_argument(
        ...
        required=False,
        default="ZZ4l2022",
        help="Files to make plots from, separated by a comma (match name in file_info.json)",
    )
    parser.add_argument(
        "-a", "--append_to_name", type=str, default="", help="Name plot as <branch_name>_<append_to_name>"
    )
    parser.add_argument(
        "--signal_files",
        type=str,
