...
def main():
    ...
    parser.add_argument(
        "-i", "--base-file", dest="infile", default="base.txt", help="template file used to create full JSON"
    )
    ...
    parser.add_argument(
        "-c", "--combined", action="store_true", help="provide xsecs with year identifiers for combined plot group"
    )
    parser.add_argument(
        "-a",
        "--analysis",
        default="Run3Combined",
        help="name of combined-year analysis to create xsec file (default: Run3Combined)",
    )
    parser.add_argument(
        "-s",
        "--skip",
